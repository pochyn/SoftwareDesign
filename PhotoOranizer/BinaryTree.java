...
public class BinaryTree {
    ...
    private BinaryNode findParent(BinaryNode curr, Object parentValue) {
    	...
    	BinaryNode parent = new BinaryNode(null); 
    	if(curr.left != null){
    		parent = findParent(curr.left, parentValue);
    	} 
    	if(curr.right != null && parent.value == null){
    		parent = findParent(curr.right, parentValue);
    	}
    ...
    private String toString(BinaryNode curr) {
    	...
    	if (curr == null) {
        	...
        	String s = new String();
        	s += curr.value;
        	s += toString(curr.left);
        	s += toString(curr.right);
        	return "(" + s + ")";
        }
